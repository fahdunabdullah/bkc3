        ...
        <div class="form-group row mt-2">
            ...
            <div class="col-sm-5">
                <textarea type="text" name="keluhan" class="form-control" cols="30" rows="5"
                    placeholder="jelaskan apa yag anda rasakan,dan apa yang membuat anda keberatan">{{ $rekam->keluhan }}</textarea>
            </div>
        </div>

        <!--------------------------------------------------------dokter pemriksa----------------------------------------------------------------------------------- -->
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">conseller</label>
            <div class="col-sm-5">
                <select name="conseller" id="">
