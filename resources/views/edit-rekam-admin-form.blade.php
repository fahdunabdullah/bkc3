            ...
            <div class="col-sm-5">
                <select name="dokter" id="" class="form-control" value="{{ $rekam->dokter->nama ?? '-' }}">
                    ...
                    @foreach ($dokter as $row)
                        <option value="{{ $row->id }}"
                            {{ $rekam->dokter != '' ?? $row->dokter->id == $row->id ? 'selected' : '' }}>
                            {{ $row->nama . ' |' }}
                            {{ $row->jadwal == '' ? 'Belum ada Jadwal' : $row->jadwal->jadwalpraktek }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="diagnosa" placeholder="Diagnosa.." required="required"
                    value="{{ $rekam->diagnosa }}" oninvalid="this.setCustomValidity('Diagnosa tidak boleh kosong')"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select name="obat" id="" class="form-control">
                    ...
                    @foreach ($obat as $o)
                        <option value="{{ $o->id }}"
                            {{ $rekam->obat != '' ?? $o->obat->nama == $o->nama->id ? 'selected' : '' }}>
                            {{ $o->nama . ' |Stok: ' . $o->stok }}</option>
                    @endforeach
                </select>
            </div>
        </div>
